...
public class Likes {
     ...
     * This field is automatically set to the current time when the like is created.
     */
    private LocalDateTime timestamp;

    /**
     * The user who liked the post. This is a reference to a {@link Users} entity.
     * The user is linked to the like through a many-to-one relationship.
    ...
    /**
     * The post that was liked. This is a reference to a {@link Posts} entity.
     * The post is linked to the like through a many-to-one relationship.
     * The field is ignored during serialization to JSON using the {@link JsonIgnore} annotation.
     */
    @ManyToOne
    ...
    /**
     * Default constructor for the Like entity.
     * The constructor automatically sets the timestamp to the current time
     ...
     *
     * @return the unique identifier for the like
     */
